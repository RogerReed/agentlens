  ...
  "env": {
    ...
    "OTEL_LOG_USER_PROMPTS": "1"
      ...
      <p style="font-size:11px;color:var(--muted);margin-top:6px;line-height:1.6">
        ...
        <strong>OTEL_SEMCONV_STABILITY_OPT_IN=gen_ai_latest_experimental</strong> opts into the latest GenAI semantic conventions, enabling LLM response content in spans.{' '}
